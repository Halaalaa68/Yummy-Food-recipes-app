...
// console.log(id)
let section= async function(){
    let res= await fetch(`https://themealdb.com/api/json/v1/1/filter.php?c=${idPrev}`)
    console.log(res)
    let data= await res.json()
    console.log(data)
    for(i=0;i<data.meals.length;i++)
        {
            temp+=`<div class="col-lg-3 col-12 col-md-6 mydiv" >
    ...
    document.querySelectorAll('.mydiv .meal a')
        .forEach( (o) => {
